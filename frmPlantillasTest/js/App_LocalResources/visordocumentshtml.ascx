...
<%
    ...
    IF clsPermisos.tepermis(objconn,3,idusuari,idusuari,  rel,0,usuariXarxa,"")=1 Then
        txtAfegirDocuments = "<a href=""~/carregaDocuments.aspx?" + HttpUtility.UrlEncode(oCodParam.encriptar("cr=" + codiRelacio.ToString())) + """ target=""_blank""><img src=""~/img/afegir.png"" alt="""" border=""0""/></a>&nbsp;"
        txtAfegirEnllaços = "<a href=""~/carregaLinks.aspx?" + HttpUtility.UrlEncode(oCodParam.encriptar("cr=" + codiRelacio.ToString())) + """ target=""_blank""><img src=""http://www.l-h.cat/img/afegirenll.gif"" alt="""" border=""0""/></a>&nbsp;"
    End If


    txtCercador = "<a href=""~/buscador.aspx?" + HttpUtility.UrlEncode(oCodParam.encriptar("codiRelacioInicial=" + codiRelacio.ToString())) + """ target=""_blank""><img src=""http://www.l-h.cat/img/cercar.gif"" border=""0"" alt=""""/></a>"
        ...
        if trim(cami) <> ""  then
            ...
            for each item in aCami
                ...
                if item <> codiRelacio Then
                    llistaCami += "<a href=""~/js/App_LocalResources/visordocumentshtml.aspx?codiRelacio=" & item & "&cami=" & nouCami
