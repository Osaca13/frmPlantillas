    ...
    */
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading: '/img/common/visorImatges/lightbox-ico-loading.gif', 	// (string) Path and the name of the loading icon

            //Cambios Raquel
            imageBtnPrev: '/img/common/visorImatges/lightbox-btn-prev.gif', 		// (string) Path and the name of the prev button image
            //imageBtnPrevCAS: 'Anterior', 		// (string) Specify text "Anterior"
            //imageBtnPrevCAT: 'Anterior', 		// (string) Specify text "Anterior"

            //Cambios Raquel
            imageBtnNext: '/img/common/visorImatges/lightbox-btn-next.gif', 		// (string) Path and the name of the next button image
            //imageBtnNextCAS: 'Siguiente', 		// (string) Specify text "Siguiente"
            //imageBtnNextCAT: 'Següent', 		// (string) Specify text "Següent"
            ...
            imageBlank: '/img/common/visorImatges/lightbox-blank.gif', 		// (string) Path and the name of a blank image (one pixel)
