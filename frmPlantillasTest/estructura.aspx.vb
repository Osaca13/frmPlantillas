        ...
        If codiRelacioOrigen.Text.Length > 0 Then
            ...
            Select Case descTipus
                ...
                Case "arbre web"
                    ...
                    GAIA.bdr(objconn, "SELECT AWEDSEST,AWEDSATR,AWEDSTVER,AWEDSTHOR,AWEDSTCO FROM METLAWE WITH(NOLOCK) WHERE AWEINNOD=" & nroNodeDesti & " UNION SELECT  CAST(AWEDSEST AS VARCHAR(8000)) AS AWEDSEST,'GAIA2' as AWEDSATR,'0' as AWEDSTVER,'0' as AWEDSTHOR,AWEDSTCO FROM METLAWE2 WITH(NOLOCK) WHERE AWEINNOD=" & nroNodeDesti, DS)
