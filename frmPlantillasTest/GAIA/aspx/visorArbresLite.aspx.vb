...
Public Class visorArbresLite
    ...
    Protected Sub tractaDragDrop(ByVal sender As Object, ByVal NodeEvent As RadTreeNodeEventArgs)
        ...
        Else
            ...
            GAIA.debug(Nothing, "Node Desti relinfil " + nroNodeDesti.ToString())
            If esGAIA2(objconn, nroNodeDesti) Then
    ...
    Protected Sub clickRetornarNodes(ByVal sender As Object, ByVal e As EventArgs)
        NodesSelected()
        retornarNodesChecked.Checked = True
    End Sub 'clickRetornarNodes

    Private Function NodesSelected()
        ...
        labelNodes.Text = nodes.Replace("""", "\""")
        labelNroNodes.Text = nroNodes.ToString()


        'Response.Write("<script language=""javascript"">opener.document.getElementById(""" + Request("c") + "TxtAbans"").value =""" & nodes.Replace("""", "\""") + """; opener.document.getElementById(""" + Request("c") + "TxtAbans"").style.height ='" & (cont * 30) & "px';opener.document.getElementById(""" & Request("c") & "NodesAbans"").value =""" & nroNodes.ToString() & """;window.close();</script>")
    ...
    Private Sub llistaArbres_canviArbre(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim objconn As OleDbConnection
        Dim rel As New clsRelacio
        objconn = GAIA.bdIni()
        ...
        End If
    End Sub
    Private Sub llistaArbres2_1_canviArbre(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim rel As New clsRelacio
        If llistaArbres2_1.SelectedItem.Value.Substring(0, 1) <> "#" Then
            rel.bdget(objconn, llistaArbres2_1.SelectedItem.Value)
        ...
        End If
    End Sub
    Private Sub llistaArbres2_2_canviArbre(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim rel As New clsRelacio
...
#Region "Web Form Designer generated code"
    ...
    Protected Sub llistaArbres_SelectedIndexChanged(sender As Object, e As EventArgs)
        Dim objconn As OleDbConnection
        Dim rel As New clsRelacio
        objconn = GAIA.bdIni()
        If llistaArbres.SelectedItem.Value.Substring(0, 1) <> "#" Then
